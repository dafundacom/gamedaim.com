  ...
  return (
    <>
      <div className="px-4">
        ...
        <div className="flex">
          <div className="h-fit mr-2 shadow-sm fixed top-[unset] bottom-0 left-0 z-40 mx-0 mb-0 mr-0 flex w-full flex-row items-center justify-center bg-white dark:bg-gray-700 lg:px-2 lg:!sticky lg:top-20 lg:bottom-[unset] lg:left-[unset] lg:!w-auto lg:bg-transparent lg:shadow-none lg:dark:bg-transparent">
            <ShareButtonArticle
