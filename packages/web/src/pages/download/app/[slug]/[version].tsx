...
export default function DownloadAppVersion(props: {
  ...
  const { downloadFile, download, downloads, settingsSite } = props
      ...
      <BreadcrumbJsonLd
        itemListElements={[
          ...
          },
          {
            ...
            item: `https://${settingsSite.url?.value || ""}/download/app/${
              download.slug
            }`,
          },
        ]}
...
export async function getServerSideProps({ params }: any) {
  ...
  return {
    props: { downloadFile, download, downloads, settingsSite },
  }
}
