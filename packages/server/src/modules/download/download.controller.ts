...
export async function updateDownloadViewCountHandler(
  ...
  try {
    ...
    const downloadView = await updateDownloadViewCount(downloadId)
    return reply.code(201).send(downloadView)
  } catch (e) {
    console.log(e)
    return reply.code(500).send(e)
  }
